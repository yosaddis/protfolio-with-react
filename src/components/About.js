      ...
      <div className="about__container bd-grid">
        ...
        <div>
          ...
          <p className="about__text">
            ...
            {' '}
            <br />
            My journey started with website design using CMSs, and I quickly transitioned to developing a Hospital Management System in C# and SQL, which led to founding
            {' '}
            <a href="https://www.sefedsystems.com">Sefed Systems</a>
            . Currently, I'm broadening my horizons through Microverse while actively working on diverse projects for various companies.
            <br />
            {' '}
            <br />
            ...
            {' '}
            <br />
            Ultimately, my goal is to make a positive impact on people's lives through technology. With two popular apps on the Play Store, I've witnessed firsthand how technology can improve lives. I'm eager to bring this unique blend of technical excellence, passion, and customer-focused mindset to your team.
            {' '}
